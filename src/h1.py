...
bind_layers(Ether, P4calc, type=0x86DD)
...
def main():
    ...
    while True:
        ...
        try:
            i,ts = p(s,0,[])
            pkt = Ether(dst='00:00:00:00:00:00', type=0x86DD) / P4calc(op=ts[1].value,
...
#from scapy.all import (Ether, sendp, Raw, IPv6, Packet)
#sendp(Ether(src='00:00:00:00:00:00', dst='00:00:00:00:00:00', type=0x86DD)/Raw('\xDE\xB0...'), iface='h1-eth1')
