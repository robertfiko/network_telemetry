...
sendp(Ether(src='00:00:00:00:00:00', dst='00:00:00:00:00:00')/INT(hop_ml=0, instruction_bitmap=0b11111111111)/IPv6(dst="::2")/SRH(segments_left=3)/SRH_segment(dst="::0001:0001")/SRH_segment(dst="::0001:0006")/SRH_segment(dst="::0001:0003"), iface='h1-eth1')